...
| 0005 | [Longest Palindromic Substring](https://leetcode.com/problems/longest-palindromic-substring) | Medium | `Dynamic Programming` `Manacher` `String` `Two Pointers` |
...
| 0037 | [Sudoku Solver](https://leetcode.com/problems/sudoku-solver) | Hard | `Algorithm X` `Array` `Backtracking` `Dancing Links` `Hash Table` `Matrix` |
...
| 0085 | [Maximal Rectangle](https://leetcode.com/problems/maximal-rectangle) | Hard | `Array` `Dynamic Programming` `Matrix` `Monotonic Stack` `Stack` |
...
| 0103 | [Binary Tree Zigzag Level Order Traversal](https://leetcode.com/problems/binary-tree-zigzag-level-order-traversal) | Medium | `Binary Tree` `Breadth-First Search` `Tree` |
...
| 0216 | [Combination Sum III](https://leetcode.com/problems/combination-sum-iii) | Medium | `Array` `Backtracking` |
...
| 0235 | [Lowest Common Ancestor of a Binary Search Tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree) | Medium | `Binary Lifting` `Binary Search Tree` `Binary Tree` `Depth-First Search` `Lowest Common Ancestor` `Tree` |
| 0236 | [Lowest Common Ancestor of a Binary Tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree) | Medium | `Binary Lifting` `Binary Tree` `Depth-First Search` `Lowest Common Ancestor` `Tree` |
...
| 0300 | [Longest Increasing Subsequence](https://leetcode.com/problems/longest-increasing-subsequence) | Medium | `Array` `Binary Search` `Dynamic Programming` `Longest Increasing Subsequence` |
...
| 0312 | [Burst Balloons](https://leetcode.com/problems/burst-balloons) | Hard | `Array` `Dynamic Programming` |
...
| 0378 | [Kth Smallest Element in a Sorted Matrix](https://leetcode.com/problems/kth-smallest-element-in-a-sorted-matrix) | Medium | `Array` `Binary Search` `Heap (Priority Queue)` `Matrix` `Sorting` |
...
| 0698 | [Partition to K Equal Sum Subsets](https://leetcode.com/problems/partition-to-k-equal-sum-subsets) | Medium | `Array` `Backtracking` `Bit Manipulation` `Bitmask` `Dynamic Programming` `Memoization` |
...
| 0741 | [Cherry Pickup](https://leetcode.com/problems/cherry-pickup) | Hard | `Array` `Dynamic Programming` `Matrix` |
...
| 0877 | [Stone Game](https://leetcode.com/problems/stone-game) | Medium | `Array` `Dynamic Programming` `Game Theory` `Math` `Minimax` `Zero-Sum Game` |
...
| 0910 | [Smallest Range II](https://leetcode.com/problems/smallest-range-ii) | Medium | `Array` `Greedy` `Math` `Sorting` |
...
| 0992 | [Subarrays with K Different Integers](https://leetcode.com/problems/subarrays-with-k-different-integers) | Hard | `Array` `Counting` `Hash Table` `Sliding Window` |
...
| 1009 | [Complement of Base 10 Integer](https://leetcode.com/problems/complement-of-base-10-integer) | Easy | `Bit Manipulation` |
...
| 1025 | [Divisor Game](https://leetcode.com/problems/divisor-game) | Easy | `Brainteaser` `Dynamic Programming` `Game Theory` `Impartial Game` `Math` |
...
| 1122 | [Relative Sort Array](https://leetcode.com/problems/relative-sort-array) | Easy | `Array` `Bubble Sort` `Counting Sort` `Hash Table` `Quicksort` `Sorting` |
...
| 1373 | [Maximum Sum BST in Binary Tree](https://leetcode.com/problems/maximum-sum-bst-in-binary-tree) | Hard | `Binary Search Tree` `Binary Tree` `DP on Trees` `Depth-First Search` `Dynamic Programming` `Tree` |
...
| 1385 | [Find the Distance Value Between Two Arrays](https://leetcode.com/problems/find-the-distance-value-between-two-arrays) | Easy | `Array` `Binary Search` `Sorting` `Two Pointers` |
| 1386 | [Cinema Seat Allocation](https://leetcode.com/problems/cinema-seat-allocation) | Medium | `Array` `Bit Manipulation` `Greedy` `Hash Table` |
...
| 1406 | [Stone Game III](https://leetcode.com/problems/stone-game-iii) | Hard | `Array` `Dynamic Programming` `Game Theory` `Math` `Minimax` `Zero-Sum Game` |
...
| 1461 | [Check If a String Contains All Binary Codes of Size K](https://leetcode.com/problems/check-if-a-string-contains-all-binary-codes-of-size-k) | Medium | `Bit Manipulation` `Directed Acyclic Graph` `Hash Function` `Hash Table` `Rolling Hash` `String` |
...
| 1781 | [Sum of Beauty of All Substrings](https://leetcode.com/problems/sum-of-beauty-of-all-substrings) | Medium | `Counting` `Hash Table` `String` |
...
| 1872 | [Stone Game VIII](https://leetcode.com/problems/stone-game-viii) | Hard | `Array` `Dynamic Programming` `Game Theory` `Math` `Minimax` `Prefix Sum` `Zero-Sum Game` |
...
| 1927 | [Sum Game](https://leetcode.com/problems/sum-game) | Medium | `Game Theory` `Greedy` `Math` `String` |
...
| 1952 | [Three Divisors](https://leetcode.com/problems/three-divisors) | Easy | `Enumeration` `Math` `Number Theory` `Prime Factorization` `Sieve Theory` |
...
| 1979 | [Find Greatest Common Divisor of Array](https://leetcode.com/problems/find-greatest-common-divisor-of-array) | Easy | `Array` `Euclidean Algorithm` `Greatest Common Divisor` `Math` `Number Theory` |
...
| 2213 | [Longest Substring of One Repeating Character](https://leetcode.com/problems/longest-substring-of-one-repeating-character) | Hard | `Array` `Ordered Set` `Segment Tree` `String` |
...
| 2260 | [Minimum Consecutive Cards to Pick Up](https://leetcode.com/problems/minimum-consecutive-cards-to-pick-up) | Medium | `Array` `Hash Table` `Sliding Window` |
| 2407 | [Longest Increasing Subsequence II](https://leetcode.com/problems/longest-increasing-subsequence-ii) | Hard | `Array` `Binary Indexed Tree` `Divide and Conquer` `Dynamic Programming` `Monotonic Queue` `Queue` `Segment Tree` |
...
| 2485 | [Find the Pivot Integer](https://leetcode.com/problems/find-the-pivot-integer) | Easy | `Math` `Prefix Sum` |
...
| 2904 | [Shortest and Lexicographically Smallest Beautiful String](https://leetcode.com/problems/shortest-and-lexicographically-smallest-beautiful-string) | Medium | `Sliding Window` `String` |
...
| 3568 | [Minimum Moves to Clean the Classroom](https://leetcode.com/problems/minimum-moves-to-clean-the-classroom) | Medium | `Array` `Bit Manipulation` `Breadth-First Search` `Hash Table` `Matrix` |
...
| 3734 | [Lexicographically Smallest Palindromic Permutation Greater Than Target](https://leetcode.com/problems/lexicographically-smallest-palindromic-permutation-greater-than-target) | Hard | `Enumeration` `String` `Two Pointers` |
